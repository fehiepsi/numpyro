...
class SVI(object):
    ...
    **Example:**
    ...
    def init(self, rng_key, *args, **kwargs):
        ...
        params = jax.tree_util.tree_map(lambda x: jax.lax.convert_element_type(x, jnp.result_type(x)), params)
    ...
    def run(self, rng_key, num_steps, *args, progress_bar=True, stable_update=False, **kwargs):
        ...
        if progress_bar:
            ...
            svi_state, losses = jax.lax.scan(body_fn, svi_state, None, length=num_steps)
